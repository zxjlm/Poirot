...
class SegDetectorRepresenter:
    ...
    def __call__(self, pred, height, width):
        ...
        batch: a dict produced by dataloaders.
            ...
            polygons: tensor of shape (N, K, 4, 2),
        the polygons of objective regions.
            ignore_tags: tensor of shape (N, K),
        indicates whether a region is ignorable or not.
        ...
        boxes, scores = self.boxes_from_bitmap(pred, segmentation, width,
                                               height)
    ...
    def get_mini_boxes(self, contour):
        ...
        box = [points[index_1], points[index_2], points[index_3],
               points[index_4]]
